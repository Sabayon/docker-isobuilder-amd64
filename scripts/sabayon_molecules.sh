...
SABAYON_MOLECULES_TORRENT_SCRIPT=${SABAYON_MOLECULES_TORRENT_SCRIPT:-${SABAYON_MOLECULES_DIR}/scripts/make_torrents.sh}
...
SABAYON_MOLECULES_TORRENT_SCRIPT = ${SABAYON_MOLECULES_TORRENT_SCRIPT}
SABAYON_MOLECULES_TORRENT        = ${SABAYON_MOLECULES_TORRENT}
${info_args}
"
  return 0
}
...
sabayon_molecules_run () {
  ...
  # Load SecureBoot keys
  if [ -e "${SABAYON_MOLECULES_SECUREBOOT_PRIVKEY}" ] ; then
